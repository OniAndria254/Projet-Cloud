...
<head>
  ...
  <style>
    ...
    /* Ajoutez d'autres styles personnalisés pour votre tableau de bord ici */
...
<div class="main-content">
  ...
  <p class="text-muted">Voici votre tableau de bord où vous pouvez visualiser vos informations importantes.</p>

  <!-- Ajoutez ici le contenu spécifique de votre tableau de bord -->
