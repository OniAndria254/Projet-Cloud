...
<div class="main-content">
  <h1>Dépôt</h1>
  <p class="text-muted">Sélectionnez la crypto-monnaie et entrez le montant à déposer.</p>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">
            Pourquoi je ne vois pas les fonds déposés ?
          </button>
        </h2>
        <div id="faq1" class="accordion-collapse collapse">
          <div class="accordion-body">
            Les dépôts peuvent prendre jusqu'à 24 heures pour apparaître dans votre compte.
          </div>
        </div>
      </div>
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">
            Que faire si j'ai atteint ma limite de dépôt ?
          </button>
        </h2>
        <div id="faq2" class="accordion-collapse collapse">
          <div class="accordion-body">
            Veuillez contacter le support client pour augmenter votre limite de dépôt.
          </div>
        </div>
      </div>
    </div>
